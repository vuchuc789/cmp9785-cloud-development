...
import { CreditDisplay } from '@/components/credis-display';
...
export default function FilesPage() {
  ...
  const handleCopyDescription = () => {
    ...
    const textToCopy = selectedFile.description ?? '';
    ...
    <main className="grow max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-6 md:py-10">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <div className="flex items-center gap-3">
          {fileResult && (
            <CreditDisplay
              availableCredits={fileResult.credit}
              maxCredits={fileResult.credit_count}
              nextRefillTime={fileResult.credit_timestamp ?? new Date()}
        ...
        >
          ...
          {!!selectedFile?.description && (
            <div className="space-y-4 mt-2">
              ...
              <div className="relative h-[400px] overflow-y-auto border rounded-md p-4 bg-card">
                <div className="sticky top-0 right-0 z-10 float-right">
                  <Tooltip>
